...
#include "crosstableeditor.h"
	...
	variableandvisibilityDialog::variableandvisibilityDialog(ATCMspinbox *widget, QWidget *parent)
: QDialog(parent)
{
	m_widget = widget;

    QLabel * spinboxVariable = new QLabel("Variable:");
    ...
    QLabel * spinboxVisibility = new QLabel("VisibilityVar:");
    ...
    variablesLayout->addWidget(spinboxVariable,0,0);
    variablesLayout->addWidget(lineVariable,0,1);
    variablesLayout->addWidget(buttonVariable,0,2);
    variablesLayout->addWidget(spinboxVisibility,1,0);
