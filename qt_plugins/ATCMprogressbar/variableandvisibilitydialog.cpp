...
#include "crosstableeditor.h"
	...
	variableandvisibilityDialog::variableandvisibilityDialog(ATCMprogressbar *widget, QWidget *parent)
: QDialog(parent)
{
	m_widget = widget;

    QLabel * progressbarVariable = new QLabel("Variable:");
    ...
    QLabel * progressbarVisibility = new QLabel("VisibilityVar:");
    ...
    variablesLayout->addWidget(progressbarVariable,0,0);
    variablesLayout->addWidget(lineVariable,0,1);
    variablesLayout->addWidget(buttonVariable,0,2);
    variablesLayout->addWidget(progressbarVisibility,1,0);
    ...
    setWindowTitle(tr("ATCM ProgressBar Variables"));
}
