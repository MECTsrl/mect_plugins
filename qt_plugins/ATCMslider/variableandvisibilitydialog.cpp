...
#include "crosstableeditor.h"
	...
	variableandvisibilityDialog::variableandvisibilityDialog(ATCMslider *widget, QWidget *parent)
: QDialog(parent)
{
	m_widget = widget;

    QLabel * sliderVariable = new QLabel("Variable:");
    ...
    QLabel * sliderVisibility = new QLabel("VisibilityVar:");
    ...
    variablesLayout->addWidget(sliderVariable,0,0);
    variablesLayout->addWidget(lineVariable,0,1);
    variablesLayout->addWidget(buttonVariable,0,2);
    variablesLayout->addWidget(sliderVisibility,1,0);
