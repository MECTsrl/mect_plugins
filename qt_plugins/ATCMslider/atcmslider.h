 ...
 ATCMslider : public QSlider
{
	Q_OBJECT
		...
		Q_PROPERTY(bool tracking READ hasTracking WRITE setTracking DESIGNABLE false)
        ...
        /* hide QSlider property */
        Q_PROPERTY(int tickInterval READ tickInterval DESIGNABLE false)
        Q_PROPERTY(TickPosition tickPosition READ tickPosition DESIGNABLE false)
        /************* new property ************ */
		...
		/* set the handler icon */
		Q_PROPERTY(QIcon icon READ icon WRITE setIcon)
		/* set the handler color */
		Q_PROPERTY(QColor handlerColor READ handlerColor WRITE setHandlerColor)
		/* set the sub color */
		Q_PROPERTY(QColor subColor READ subColor WRITE setSubColor)
		/* set the add color */
		Q_PROPERTY(QColor addColor READ addColor WRITE setAddColor)
	...
	public:
		...
		QColor handlerColor() const;
		QIcon icon() const;
		QColor subColor() const;
		QColor addColor() const;
	...
	public Q_SLOTS:
		...
		void setHandlerColor(const QColor& handlerColor);
		void setSubColor(const QColor& subColor);
		void setAddColor(const QColor& addColor);
