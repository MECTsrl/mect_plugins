...
call :screenAndLog "Building  Qt %QT_VERSION% in %IMX28_DIR% not yet completed !!"
Pause
Rem ---- Updating PATH if needed
call :addToPath "%CC_DIR%bin"
call :addToPath %CC_DIR%i686-w64-mingw32\bin;
...
mingw32-make  2>&1 | "%TEE%" %STARTDIR%\Qt487-imx28-make.log
if errorlevel 1 (
...
call :screenAndLog "Installing  Qt %QT_VERSION% in %IMX28_DIR% not yet completed !!"
Pause
...
mingw32-make install 2>&1 | "%TEE%" -a %TEMP_DIR%Qt487-imx28-Install.log
if errorlevel 1 (
