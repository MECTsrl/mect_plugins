...
void info::refreshSystemTab()
{
    ...
    ui->sys_text->appendPlainText((QString("PLC_PRODUCT_ID: 0x%1").arg(uvalue, 8, 16, QChar('0'))).toUpper());
    ...
    ui->sys_text->appendPlainText((QString("PLC_MS_VERSION: 0x%1").arg(uvalue, 6, 16, QChar('0'))).toUpper());
